              ...
              <div className="border-t border-indigo-200 pt-2">
                ...
                {!miResult.demand || miResult.demand.status === 'not_configured' ? (
                  ...
                  <div className="text-xs text-indigo-800 space-y-1">
                    ...
                    {miResult.demand.avgMonthlySearches && miResult.demand.avgMonthlySearches.length > 0 && <p>Avg monthly searches (USA): <span className="font-semibold">{miResult.demand.avgMonthlySearches.map((n) => n.toLocaleString()).join(' · ')}</span> — search-volume evidence only; does NOT prove purchases, conversion, sales, or Himalayan Koh profitability.</p>}

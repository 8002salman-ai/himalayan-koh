...
export const SETTINGS_REGISTRY: SettingsCategory[] = [
  ...
  {
    id: 'dealer_program',
    label: 'Wholesale Program — Defaults',
    description: 'Default terms applied to new wholesale approvals. Individual wholesalers can still be overridden in Wholesale Management.',
    fields: [
      {
        ...
        type: 'text',
        placeholder: '30',
        hint: 'Net terms applied to a wholesaler when first approved, e.g. 30 for Net 30.',
        envFallback: 'DEALER_DEFAULT_CREDIT_TERMS',
      },
      {
        key: 'min_order_value',
        label: 'Minimum Wholesale Order Value ($)',
        type: 'text',
        placeholder: '250',
        hint: 'Informational minimum shown to wholesalers — not yet enforced at checkout.',
        envFallback: 'DEALER_MIN_ORDER_VALUE',
      },
      {
        key: 'support_email',
        label: 'Wholesale Support Email',
        type: 'email',
        placeholder: 'dealers@himalayankoh.com',
        hint: 'Shown on the wholesale support page and in approval emails.',

...
export const PRIVACY_SECTIONS: PolicySection[] = [
  ...
  { title: 'Children\'s Privacy', body: 'Luxedge is not directed to children under 13, and we do not knowingly collect personal information from children under 13. If you believe a child has provided information to us, contact sales@himalayankoh.com so we can review it and delete it where appropriate.' },
  ...
  { title: 'Contact Us', body: 'Questions about this Privacy Policy? Email sales@himalayankoh.com or call (440) 941-8002. Luxedge is operated by Embani LLC, 1500 N Grant St, Denver, CO 80203, United States.' },
];
...
export const TERMS_SECTIONS: PolicySection[] = [
  ...
  { title: 'Governing Law', body: 'Luxedge is operated by Embani LLC, registered in Denver, Colorado, United States. These Terms of Service and any dispute or claim arising out of or in connection with them shall be governed by and construed in accordance with the laws of the State of Colorado and applicable federal law of the United States, without giving effect to any choice or conflict of law provision. Any dispute should first be raised with us at sales@himalayankoh.com so we can try to resolve it directly.' },
  { title: 'Changes and Contact', body: 'We may update these Terms by posting a revised version with a new date. Continued use of the site after an update means the revised Terms apply. If any part of these Terms is found unenforceable, the remaining parts continue to apply. Questions about an order, a return, or these Terms: email sales@himalayankoh.com or call (440) 941-8002, Monday to Friday, 9AM–6PM CT.' },
];
...
export const RETURNS_SECTIONS: PolicySection[] = [
  ...
  { title: 'Contact Us', body: 'Questions about returns? Email sales@himalayankoh.com or call (440) 941-8002. Luxedge is operated by Embani LLC, 1500 N Grant St, Denver, CO 80203, United States.' },
];
...
export const COPYRIGHT_SECTIONS: PolicySection[] = [
  ...
  { title: 'Contact', body: 'Copyright questions and notices: email sales@himalayankoh.com or call (440) 941-8002, Monday to Friday, 9AM\u20136PM CT. Luxedge is operated by Embani LLC, 1500 N Grant St, Denver, CO 80203, United States.' },
];
...
export const DISCLAIMER_SECTIONS: PolicySection[] = [
  ...
  { title: 'Questions and corrections', body: 'If a page contains an error, a broken link, or a product detail you need clarified, email sales@himalayankoh.com or call (440) 941-8002. Luxedge is operated by Embani LLC, 1500 N Grant St, Denver, CO 80203, United States.' },
];
...
export const FAQ_DATA: FaqCategory[] = [
  ...
  { category: 'Account & Support', items: [
    ...
    { q: 'How do I contact customer support?', a: 'Email sales@himalayankoh.com or call (440) 941-8002. Our support team is available Monday-Friday, 9 AM - 6 PM CT. We typically respond to emails within 24 hours.' },

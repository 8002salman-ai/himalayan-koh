...
export const products: Product[] = [
  ...
  },
  {
    ...
    priceMin: 49.95,
    image: legacyImage('cattleSaltBag'),
    images: [legacyImage('cattleSaltBag'), legacyImage('saltRockBag')],
    category: 'Salt for Cattle',
    ...
    inStock: true,
    metaTitle: 'Himalayan Salt Block 30 lbs for Cattle & Livestock | Himalayan Koh',
    metaDescription: 'Natural 30 lb Himalayan salt block for cattle and livestock. Retail price $49.95.',
  },
  {
    id: 11,
    ...
    priceMin: 79.80,
    image: legacyImage('cattleSaltBag'),
    images: [legacyImage('cattleSaltBag'), legacyImage('cattleGrazing')],
    category: 'Salt for Cattle',
    ...
    inStock: true,
    metaTitle: 'Himalayan Salt Lick 5–6 lbs, 4 pcs per Box for Cattle | Himalayan Koh',
    metaDescription: 'Four 5–6 lb Himalayan salt licks with rope for cattle and livestock. Box retail $79.80.',
  },
  {
    id: 12,
    ...
    inStock: true,
    metaTitle: 'Himalayan Salt Lick 1–2 lbs, 6 pcs per Box for Cattle | Himalayan Koh',
    metaDescription: 'Six 1–2 lb Himalayan salt licks with rope for cattle and livestock. Box retail $77.70.',
  },
  {
    id: 13,
  ...
  },
  {
    ...
    priceMin: 49.95,
    image: legacyImage('saltRockBag'),
    images: [legacyImage('saltRockBag'), legacyImage('cattleGrazing')],
    category: 'Salt for Cattle',
    ...
    inStock: true,
    metaTitle: 'Himalayan Rock Salt 45 lbs, 2–3 Large Chunks for Cattle | Himalayan Koh',
    metaDescription: 'Natural 45 lb Himalayan rock salt package with approximately 2–3 large chunks for cattle and livestock.',
  },
];

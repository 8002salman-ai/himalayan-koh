...
} from './lib/public-supabase-env.mjs';
...
// The public Supabase values are required by the browser auth client. A clean
// worktree may not contain ignored env files, so DEPLOY_PUBLIC_ENV_FILE can
// point at an approved local source in the parent checkout. Only the four
// public keys are parsed; service-role and other server secrets are ignored.
const explicitEnvFile = process.env.DEPLOY_PUBLIC_ENV_FILE
